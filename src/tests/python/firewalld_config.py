...
class TestFirewallDInterfaceConfig(unittest.TestCase):
    ...
    def test_zones(self):
        ...
        self.assertEqual(zone_settings.getForwardPorts().sort(), zone_forward_ports.sort())
        ...
        self.assertEqual(self.fw.getIcmpBlocks(zone_name).sort(), zone_icmpblocks.sort())
        self.assertEqual(self.fw.queryMasquerade(zone_name), zone_masquerade)
        self.assertEqual(self.fw.getForwardPorts(zone_name).sort(), zone_forward_ports.sort())
    ...
    def test_icmptypes(self):
        ...
        self.assertEqual(icmptype_settings.getDestinations().sort(), icmptype_destinations.sort())
