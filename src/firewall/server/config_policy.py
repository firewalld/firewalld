...
class FirewallDConfigPolicy(DbusServiceObject):
    ...
    @dbus_service_method(
        config.dbus.DBUS_INTERFACE_CONFIG_POLICY, out_signature="a{sv}"
    )
    @dbus_handle_exceptions
    ...
    @dbus_service_method(config.dbus.DBUS_INTERFACE_CONFIG_POLICY, in_signature="a{sv}")
    @dbus_handle_exceptions
    ...
    @dbus_service_method(config.dbus.DBUS_INTERFACE_CONFIG_POLICY, in_signature="s")
    @dbus_handle_exceptions
